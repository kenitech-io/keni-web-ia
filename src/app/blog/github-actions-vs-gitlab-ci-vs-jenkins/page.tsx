          ...
          <Container>
            <div className="max-w-[640px] mx-auto">
              <FadeIn>
                ...
                <p className="text-label text-muted">March 17, 2026 &middot; 9 min read</p>
              </FadeIn>
            </div>
          </Container>
        </section>
        ...
        <section className="pb-section">
          <Container>
            <div className="max-w-[640px] mx-auto space-y-8">
              ...
              <FadeIn delay={0.2}>
                <h2 className="text-heading text-foreground">Setup and time to first pipeline</h2>
              </FadeIn>
              ...
              <FadeIn delay={0.2}>
                <h2 className="text-heading text-foreground">Pipeline syntax</h2>
              </FadeIn>
              ...
              <FadeIn delay={0.2}>
                <h2 className="text-heading text-foreground">Self-hosted runners</h2>
              </FadeIn>
              ...
              <FadeIn delay={0.2}>
                <h2 className="text-heading text-foreground">Ecosystem and integrations</h2>
              </FadeIn>
              ...
              <FadeIn delay={0.2}>
                <h2 className="text-heading text-foreground">Pricing</h2>
              </FadeIn>
              ...
              <FadeIn delay={0.2}>
                <h2 className="text-heading text-foreground">Security</h2>
              </FadeIn>
