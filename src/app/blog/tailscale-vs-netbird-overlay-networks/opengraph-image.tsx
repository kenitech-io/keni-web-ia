  ...
  return new ImageResponse(
    (
      <div style={{ background: "#000000", width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", padding: "80px" }}>
        ...
        <div style={{ fontSize: 48, fontWeight: 300, color: "#FAFAFA", lineHeight: 1.2, maxWidth: 900 }}>Tailscale vs Netbird vs ZeroTier: overlay networks for small teams</div>
        <div style={{ fontSize: 20, color: "#999999", marginTop: 32, maxWidth: 700, lineHeight: 1.6 }}>Self-hosted vs managed, WireGuard internals, and which one fits your setup.</div>
