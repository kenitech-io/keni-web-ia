      ...
      <section className="px-3 pt-3">
        <FadeIn>
          <div className="bg-white dark:bg-[#1c1c1e] py-24 md:py-32 px-8">
            ...
            <div className="max-w-[1000px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-x-20 md:gap-y-16">
      ...
      <section className="px-3 pt-3">
        <FadeIn>
          <div className="py-24 md:py-32 px-8 bg-light-gradient">
            ...
            <div className="max-w-[900px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12 mt-16">
              <FadeIn delay={0.1}>
