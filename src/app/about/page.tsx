          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <FadeIn delay={0}>
              <Link href="/blog/why-smbs-need-devops" className="group block">
                <div className="bg-[#f0f4e8] rounded-xl aspect-[4/3] mb-4 transition-transform duration-300 group-hover:scale-[1.02] flex items-center justify-center p-8">
                  <svg className="w-full h-full max-w-[180px]" viewBox="0 0 200 200" fill="none" stroke="#2d3a1d" strokeWidth="1.5" strokeLinecap="round" strokeDasharray="8 6">
                    <circle cx="100" cy="100" r="8" fill="#2d3a1d" strokeDasharray="0" />
            ...
            <FadeIn delay={0.08}>
              <Link href="/blog/devops-audit-what-to-expect" className="group block">
                <div className="bg-[#f0f4e8] rounded-xl aspect-[4/3] mb-4 transition-transform duration-300 group-hover:scale-[1.02] flex items-center justify-center p-8">
                  <svg className="w-full h-full max-w-[140px]" viewBox="0 0 200 200" fill="none" stroke="#2d3a1d" strokeWidth="1.5" strokeLinecap="round">
            ...
            <FadeIn delay={0.16}>
              <Link href="/blog/how-much-does-devops-cost" className="group block">
                <div className="bg-[#e8eef4] rounded-xl aspect-[4/3] mb-4 transition-transform duration-300 group-hover:scale-[1.02] flex items-center justify-center p-8">
                  <svg className="w-full h-full max-w-[160px]" viewBox="0 0 200 200" fill="none" stroke="#1d2d3a" strokeWidth="1.5" strokeLinecap="round">
                    ...
                    <circle cx="40" cy="80" r="4" fill="#1d2d3a" strokeDasharray="0" />
                    <circle cx="80" cy="60" r="4" fill="#1d2d3a" strokeDasharray="0" />
                    <circle cx="120" cy="100" r="4" fill="#1d2d3a" strokeDasharray="0" />
                    <circle cx="160" cy="45" r="4" fill="#1d2d3a" strokeDasharray="0" />
                  </svg>
                </div>
            ...
            <FadeIn delay={0.24}>
              <Link href="/blog/devops-checklist-for-startups" className="group block">
                <div className="bg-[#eee8f4] rounded-xl aspect-[4/3] mb-4 transition-transform duration-300 group-hover:scale-[1.02] flex items-center justify-center p-8">
                  <svg className="w-full h-full max-w-[140px]" viewBox="0 0 200 200" fill="none" stroke="#2d1d3a" strokeWidth="1.5" strokeLinecap="round">
