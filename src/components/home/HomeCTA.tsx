          ...
          <FadeIn delay={0.1}>
            <div>
              ...
              <a
                ...
                className="inline-block bg-foreground hover:bg-foreground/85 text-background px-8 py-2 md:px-10 md:py-3 text-sm md:text-base font-light tracking-wide rounded-full transition-colors"
              >
                Let&apos;s talk
              </a>
              <div className="mt-6">
